...
<template>
  <mars-dialog :draggable="true" title="图层" width="300" :min-width="250" top="60" right="10">
    <mars-tree v-model:checkedKeys="checkedKeys" checkable :tree-data="treeData" @check="checkedChange">
      <!-- 不想让他默认展开 -->
      <!-- <mars-tree v-model:expandedKeys="expandedKeys" v-model:checkedKeys="checkedKeys" checkable :tree-data="treeData" @check="checkedChange"> -->
      <template #title="node">
