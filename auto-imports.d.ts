...
declare global {
  ...
  const Cesium: typeof import('mars3d-cesium')
  ...
  const config: typeof import('./src/store/app')['config']
  ...
  const mars3d: typeof import('mars3d')
  ...
  const title: typeof import('./src/store/app')['title']
  ...
  const useMap: typeof import('./src/store/app')['useMap']
